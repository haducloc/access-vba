...
Public Sub InsertRowAdo( _
    ...
    Set values = AssertNotNothing(values, "XAdoCrud.InsertRowAdo", "values is Nothing.")

    Set cmd = CreateCommandAdo(cn, BuildInsertSqlAdo(tableName, fieldsCsv))
...
Public Sub UpdateRowAdo( _
    ...
    Set values = AssertNotNothing(values, "XAdoCrud.UpdateRowAdo", "values is Nothing.")

    Set cmd = CreateCommandAdo(cn, BuildUpdateSqlAdo(tableName, setFieldsCsv, whereFieldsCsv))
...
Public Sub DeleteRowAdo( _
    ...
    Set values = AssertNotNothing(values, "XAdoCrud.DeleteRowAdo", "values is Nothing.")

    Set cmd = CreateCommandAdo(cn, BuildDeleteSqlAdo(tableName, whereFieldsCsv))
...
Public Function GetRowByPkAdo( _
    ...
    Set values = AssertNotNothing(values, "XAdoCrud.GetRowByPkAdo", "values is Nothing.")
    ...
    Set cmd = CreateCommandAdo(cn, BuildSelectByPkSqlAdo(tableName, pkFieldsCsv))
...
Private Function BuildInsertSqlAdo(ByVal tableName As String, ByVal fieldsCsv As String) As String
    ...
    BuildInsertSqlAdo = "INSERT INTO " & tableName & " (" & colsSql & ") VALUES (" & valsSql & ");"
End Function

' Build UPDATE SQL with positional ? placeholders: SET fields first, then WHERE fields.
Private Function BuildUpdateSqlAdo(ByVal tableName As String, ByVal setFieldsCsv As String, ByVal whereFieldsCsv As String) As String
    ...
    BuildUpdateSqlAdo = "UPDATE " & tableName & " SET " & setSql & " WHERE " & whereSql & ";"
End Function

' Build DELETE SQL with positional ? placeholders matching whereFieldsCsv order.
Private Function BuildDeleteSqlAdo(ByVal tableName As String, ByVal whereFieldsCsv As String) As String
    Dim whereFields() As String
    Dim whereSql As String
    Dim i As Long
    Dim f As String
    ...
    BuildDeleteSqlAdo = "DELETE FROM " & tableName & " WHERE " & whereSql & ";"
End Function

' Build SELECT * by PK SQL with positional ? placeholders matching pkFieldsCsv order.
Private Function BuildSelectByPkSqlAdo(ByVal tableName As String, ByVal pkFieldsCsv As String) As String
    ...
    BuildSelectByPkSqlAdo = "SELECT * FROM " & tableName & " WHERE " & whereSql & ";"
End Function
...
Private Sub AppendParamsFromValuesAdo(ByVal cmd As Object, ByVal fieldsCsv As String, ByVal typesCsv As String, ByVal values As Object)
    ...
    Set values = AssertNotNothing(values, "XAdoCrud.AppendParamsFromValuesAdo", "values is Nothing.")
