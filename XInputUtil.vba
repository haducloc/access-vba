...
Public Function GetString(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim v As Variant
...
Public Function GetCode(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim v As Variant
    v = TrimToNull(ctrl.Value)
...
Public Function GetByte(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
...
Public Function GetUByte(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetInt2(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetInt4(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetInt8(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetFloat(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetDouble(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetDecimal(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetDate(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetTime(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetDateTime(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
...
Public Function GetBool(ctrl As Control, Optional fieldName As String = vbEmptyString, Optional required As Boolean = False) As XInputState
    Dim parsed As Variant, ok As Boolean
